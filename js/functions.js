...
$(window).scroll(function () {
  var scroll = $(window).scrollTop();
  if (scroll > 0) {
    $(".header_logotop").addClass("active");
  } else {
    $(".header_logotop").removeClass("active");
  }
});
...
$(window).scroll(function () {
  var scroll = $(window).scrollTop();
  if (scroll > 0) {
    $(".header_logotop2").addClass("active");
  } else {
    $(".header_logotop2").removeClass("active");
  }
});
...
$(window).scroll(function () {
  var scroll = $(window).scrollTop();
  if (scroll > 0) {
    $(".header_logosub").addClass("active");
  } else {
    $(".header_logosub").removeClass("active");
  }
});
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const links = document.querySelectorAll(".works-link");
